...
$defaults = [
    ...
    'title' => 'Prueba CalDAV PsicoLogic',
    'description' => 'Evento de prueba creado desde PsicoLogic.',
...
<head>
    ...
    <style>
        :root { --primary-color: <?= htmlspecialchars($branding['primary_color'] ?? '#8f7fba', ENT_QUOTES, 'UTF-8') ?>; }
