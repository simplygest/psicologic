...
function render_public_nav($mysqli, array $branding, array $options = [])
{
    ...
    $profile_image_path = trim((string) ($branding['profile_image_path'] ?? '')) !== ''
        ? app_upload_asset_url($branding['profile_image_path'])
        : app_official_brand_logo_url();
    ...
    <nav class="navbar navbar-expand-lg public-navbar">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center gap-2" href="index.php">
                <img src="<?= htmlspecialchars($profile_image_path) ?>" alt="<?= htmlspecialchars($app_name) ?>" class="brand-avatar">
