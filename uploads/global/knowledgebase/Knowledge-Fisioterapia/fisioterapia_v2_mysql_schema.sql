CREATE TABLE fisioterapia_v2_fuentes (
...
CREATE TABLE fisioterapia_v2_areas (
  area_id VARCHAR(20) PRIMARY KEY,
  nombre VARCHAR(200),
  descripcion TEXT
);

CREATE TABLE fisioterapia_v2_problemas_objetivos (
...
CREATE TABLE fisioterapia_v2_tecnicas_metodos (
...
CREATE TABLE fisioterapia_v2_tareas_pautas (
...
CREATE TABLE fisioterapia_v2_problema_tecnica (
  problema_id VARCHAR(20),
  tecnica_id VARCHAR(20),
  PRIMARY KEY(problema_id, tecnica_id)
);

CREATE TABLE fisioterapia_v2_recomendaciones_tareas (
...
CREATE TABLE fisioterapia_v2_evaluaciones_indicadores (
...
CREATE TABLE fisioterapia_v2_documentos_informes (
...
CREATE TABLE fisioterapia_v2_bodymuscles_map (
  map_id VARCHAR(20) PRIMARY KEY,
  grupo_clinico VARCHAR(120),
  bodymuscles_region_ids TEXT,
  descripcion TEXT
);
