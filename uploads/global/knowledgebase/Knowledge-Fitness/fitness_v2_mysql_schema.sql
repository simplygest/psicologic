CREATE TABLE fitness_v2_fuentes (
...
CREATE TABLE fitness_v2_areas (
  area_id VARCHAR(20) PRIMARY KEY,
  nombre VARCHAR(200),
  descripcion TEXT
);

CREATE TABLE fitness_v2_problemas_objetivos (
...
CREATE TABLE fitness_v2_tecnicas_metodos (
...
CREATE TABLE fitness_v2_tareas_pautas (
...
CREATE TABLE fitness_v2_problema_tecnica (
  problema_id VARCHAR(20),
  tecnica_id VARCHAR(20),
  PRIMARY KEY(problema_id, tecnica_id)
);

CREATE TABLE fitness_v2_recomendaciones_tareas (
...
CREATE TABLE fitness_v2_evaluaciones_indicadores (
...
CREATE TABLE fitness_v2_documentos_informes (
...
CREATE TABLE fitness_v2_rutinas (
  rutina_id VARCHAR(20) PRIMARY KEY,
  nombre VARCHAR(220),
  area_id VARCHAR(20),
  nivel VARCHAR(120),
...
CREATE TABLE fitness_v2_rutina_tareas (
  rutina_id VARCHAR(20),
  tarea_id VARCHAR(20),
  PRIMARY KEY(rutina_id, tarea_id)
);
