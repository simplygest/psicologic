CREATE TABLE psicologia_v2_fuentes (
...
CREATE TABLE psicologia_v2_areas (
  area_id VARCHAR(20) PRIMARY KEY,
  nombre VARCHAR(180),
  descripcion TEXT
);

CREATE TABLE psicologia_v2_problemas_objetivos (
...
CREATE TABLE psicologia_v2_tecnicas_metodos (
...
CREATE TABLE psicologia_v2_tareas_pautas (
...
CREATE TABLE psicologia_v2_problema_tecnica (
  problema_id VARCHAR(20),
  tecnica_id VARCHAR(20),
  PRIMARY KEY(problema_id, tecnica_id)
);

CREATE TABLE psicologia_v2_recomendaciones_tareas (
...
CREATE TABLE psicologia_v2_evaluaciones_indicadores (
...
CREATE TABLE psicologia_v2_documentos_informes (
