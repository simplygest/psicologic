CREATE TABLE sexologia_fuentes (
...
CREATE TABLE sexologia_areas (
  area_id VARCHAR(20) PRIMARY KEY,
  nombre VARCHAR(200),
  descripcion TEXT
);

CREATE TABLE sexologia_problemas_objetivos (
...
CREATE TABLE sexologia_tecnicas_metodos (
...
CREATE TABLE sexologia_tareas_pautas (
...
CREATE TABLE sexologia_problema_tecnica (
  problema_id VARCHAR(20),
  tecnica_id VARCHAR(20),
  PRIMARY KEY(problema_id, tecnica_id)
);

CREATE TABLE sexologia_recomendaciones_tareas (
...
CREATE TABLE sexologia_evaluaciones_indicadores (
...
CREATE TABLE sexologia_documentos_informes (
